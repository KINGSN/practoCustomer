package com.darwinbark.fabcustomer.preferences;
...
public class SharedPrefrence {
    ...
    public void setParentUser2(User1DTO user1DTO, String tag) {

        Gson gson = new Gson();
        String hashMapString = gson.toJson(user1DTO);
    ...
    public User1DTO getParentUser2(String tag) {
        String obj = myPrefs.getString(tag, "defValue");
        if (obj.equals("defValue")) {
            return new User1DTO();
        } else {
            Gson gson = new Gson();
            String storedHashMapString = myPrefs.getString(tag, "");
            Type type = new TypeToken<User1DTO>() {
            }.getType();
            User1DTO testHashMap = gson.fromJson(storedHashMapString, type);
            return testHashMap;
        }
    }
}
