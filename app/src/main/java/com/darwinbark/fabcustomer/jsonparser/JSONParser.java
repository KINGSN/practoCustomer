package com.darwinbark.fabcustomer.jsonparser;

import android.content.Context;
import android.content.Intent;

import com.darwinbark.fabcustomer.preferences.SharedPrefrence;
import com.darwinbark.fabcustomer.ui.activity.SignInActivity;
...
public class JSONParser {
  ...
  //  public String darwinbarkk = "darwinbarkk";
    ...
    public JSONObject darwinbarkk;


    public static String TAG_SUCCESS = "status";
    public static String TAG_SUCCESS2 = "success";
    ...
    public JSONParser(Context context, JSONObject response) {
        try {
            ...
            //darwinbarkk = response.getJsonObject("darwinbarkk");
