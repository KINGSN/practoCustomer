...
import com.darwinbark.fabcustomer.dto.LocationDTO;
import com.darwinbark.fabcustomer.R;
import com.darwinbark.fabcustomer.databinding.ActivityMapBinding;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void addMarker(GoogleMap googleMap, double lat, double lon) {
        ...
        if (markerCount == 1) {
            ...
            mMap.animateCamera(cameraUpdate);
            marker = mMap.addMarker(new MarkerOptions().position(new LatLng(lat, lon)).title(getResources().getString(R.string.doctor_here)).icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_car)));
