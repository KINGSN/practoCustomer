...
import com.darwinbark.fabcustomer.databinding.ActivityProfileSettingBinding;
import com.darwinbark.fabcustomer.databinding.DailogAddressBinding;
import com.darwinbark.fabcustomer.databinding.DailogPersonalInfoBinding;
   ...
   private String TAG ="KINGSN";
                    ...
                    case R.id.gallery_cards:
                        if (ProjectUtils.hasPermissionInManifest(getActivity(), PICK_FROM_CAMERA, Manifest.permission.CAMERA)) {
                            if (ProjectUtils.hasPermissionInManifest(getActivity(), PICK_FROM_GALLERY, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                                ...
                                Log.d(TAG, "onClick: hello picUri"+picUri);
                              ...
                              /*  Intent intent=new Intent(Intent.ACTION_PICK);
                                intent.setType("image/*");*/
                               // startActivityForResult(Intent.createChooser(intent,"Browse Image"),PICK_FROM_GALLERY);
    ...
    private File getOutputMediaFile(int type) {
       ...
       /* File mediaStorageDir =new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES).toString() + File.separator + Consts.APP_NAME);*/
